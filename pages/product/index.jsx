                      ...
                      <div className="product__list__item__desc w-full py-[10px]">
                        ...
                        <div className="product__list__item__desc__text text-[16px] leading-[16px] font-light">
                          <p>
                            ...
                            elit. Nesciunt nam consequuntur, ab excepturi officiis
                            architecto nobis mollitia debitis repellendus tempore
                            laborum eum consectetur. Exercitationem eum porro
                            perferendis doloribus a. Blanditiis!
                          </p>
                        </div>
                      </div>
                      <hr className="solid"></hr>
